import {
  ...
  FoodTrackingAndAnalysis,
  LifestyleAndBehaviorCoaching,
  MealPlanningAndRecipes,
  NutritionPlans,
  NutritionalEducationAndWorkshops,
} from '@/components/Icons'

export const CardsFeaturesConfig = [
  {
    icon: <NutritionPlans />,
  ...
  {
    icon: <LifestyleAndBehaviorCoaching />,
  ...
  {
    icon: <NutritionalEducationAndWorkshops />,
